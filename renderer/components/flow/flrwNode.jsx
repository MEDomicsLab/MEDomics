          ...
          header={
            <>
              {!data.internal.isRuning ? (
                ...
                <div className="spinner-border spinner-border-sm w-2 h-2 text-success" style={{ marginTop: "0.2rem" }} role="status">
